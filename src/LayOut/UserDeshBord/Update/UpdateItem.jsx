...
const UpdateItem = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await publicUrl.post(imgUplodeApi, imageFile, {
            headers: {
        ...
        if (res.data.success) {
            ...
            // 
            const menuRes = await baseUrl.patch(`/menu/${_id}`, menuItem);
    ...
    return (
        <div>
        <HeadTitle hadding="Update an Item" subHadding="Refresh info"></HeadTitle>
